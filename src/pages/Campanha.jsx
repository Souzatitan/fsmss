        ...
        <div>
            ...
            <main>
                <div className={style.sobre}>
                    <h1>Campanha 4X4</h1>
                        <br></br><br></br>
                    <h2>4 horas para atender e 4 leitos por mil habitantes</h2>
                    <br></br><br></br><br></br>
                        <p>Propomos duas bandeiras centrais de luta para salvaguardar os direitos humanos:
                    ...
                    <br></br><br></br>
                        ...
                        Essas bandeiras conduziram a  CAMPANHA 4x4: 4 horas para atender e 4 leitos por mil habitantes, o ativismo em busca do respeito máximo aos direitos do acesso à saúde e seus 4 eixos de luta e suas 14 metas:</p> 
                    <br></br>
                        <h1><u>EIXOS</u></h1>
                    <br></br>
                    <br></br>
                    <p>1- Desbanalização do sofrimento da população nos serviços de saúde, especialmente nas urgências, lutando pela constituição de respostas suficientes em quantidade e qualidade para todos e todas, observando as necessidades de forma integral e com equidade, eliminando o tempo prolongado de espera, e erradicando as mortes evitáveis, a sobre-morbidade e exposição a enfermidades e traumatismos, hoje negligenciados pelas políticas de Estado e por muitas gestões de saúde;
                    <br></br>
                    <br></br>
                    ...
                    <br></br>
                    <br></br>
                    4- Instalação e atuação de comitês gestores participativos nos serviços de urgências com a participação paritária entre usuários e não-usuários e ouvidorias ativas / responsáveis de gestão clínica – nas redes de atenção básica, nos SAMU, Pronto Atendimentos e Serviços de Urgência Hospitalares.</p>
                    <br></br>
                    <br></br>
                    <h1>METAS</h1>
                    <br></br>
                    <br></br>
                    <p>1-Nenhum paciente internado nos serviços hospitalares de urgências ou nas UPAs (estimulando protocolos de máxima capacidade das unidades de internação, criando leitos de cuidado intermediário e responsabilização das equipes de internação pelos pacientes com prescrição de hospitalização retidos nas urgências); 
                    <br></br>
                    <br></br>
