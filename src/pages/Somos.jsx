...
​                   <br></br>
                   <br></br>
                    ...
                    <br></br><br></br>O FSMSSS integra o Comitê Executivo do G2H2 <a href='https://g2h2.org/' target='_blank'>(<u>Genebra Hub for Global Health</u>)</a>, um escritório de enlace em Genebra para advocacy nos espaços da ONU. Também participa do Comitê Executivo do Movimento pela Equidade em Saúde – SHEM <a href='https://www.sustainablehealthequity.org' target='blank'>(<u>Sustainable Health Equity Movement </u>).</a> Ainda, atua conjuntamente em projetos com o <a href='https://www.gritodosexcluidos.com/' target='_blank'><u>Grito Dos/as Excluídos/as Continental</u>.</a> Participa, também, da <u>Ágora dos/das Habitantes da Terra</u>.
                    <br></br><br></br>Somos uma plataforma sustentada pelo trabalho voluntário e, sem financiamento regular, mobilizamos recursos para cada atividade e contamos com a solidariedade das organizações participantes. <br></br>Para unir-se a nós, acesse nossos editais de voluntariado e <a href='./contato'><strong>entre em contato</strong></a> conosco para apoio, como pessoa física ou organização.</p>
